...
static const char *fonts[]          = { "AdwaitaMono Nerd Font Mono:size=10.70" };
static const char dmenufont[]       =   "AdwaitaMono Nerd Font Mono:size=10.70";
...
// check with xrandr and match that refresh rate:
